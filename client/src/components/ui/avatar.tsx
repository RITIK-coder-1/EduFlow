...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "bg-primary text-primary-foreground ring-background absolute left-4 bottom-1 z-10 inline-flex items-center justify-center rounded-full ring-2 select-none",
